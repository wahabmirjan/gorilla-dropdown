...
;(function ($) {
   ...
   */
				...
				return this.each(function () {
					...
					$(divWrapper).find(".current").click(function () {
						...
						$(document).click(sessionStorageData, function (event) {
							...
							if ($(event.target).closest(dropdownClassSelector).length == 0 || dataFromSessionStorage.indexOfLastDropdownClicked != event.data.indexOfLastDropdownClicked) {
	...
	$.fn.gorillaDropdown = function (methodsOrOptions) {
		...
		} else if ((typeof methodsOrOptions === "undefined" ? "undefined" : _typeof(methodsOrOptions)) === "object" || !methodsOrOptions) {
